          ...
          <div className="sub-slider">
            <div className="sub-slider-block">
              ...
              <div className="sub-slider-about">
                <h4>
                  {" "}
                  Nova Post in Ukraine is an express delivery company founded in
                  2001. Its goal is to provide easy delivery for every customer
                  to a branch, parcel locker, or a specific address. The company
                  provides logistics and distribution services, delivering both
                  documents and the tiniest parcels, as well as large cargos.
                </h4>
              </div>
            ...
            <div className="sub-slider-block">
              ...
              <div className="sub-slider-about">
                <h4>
                  {" "}
                  Nova Post in Europe is a logistics company that offers a full
                  range of logistics services for both private individuals and
                  business clients, ensuring fast and reliable delivery of
                  documents, parcels, and cargo across Europe, as well as
              ...
              <div className="sub-slider-points-wrapper">
                ...
                <div className="sub-slider-points">
                  <div className="sub-slider-point">
                    ...
                    <div className="sub-slider-point-text">
                      Fast delivery of documents, parcels, and cargo up to 1,100
                      kg to Ukraine within 3 days or more
                    </div>
                  </div>
                  <div className="sub-slider-point">
                    <div className="sub-slider-point-icon">
            ...
            <div className="people-slide">
              ...
              <div className="people-slide-about">
                ...
                <div className="people-slide-text">
                  Viacheslav is a businessman with over 20 years of experience,
                  and a socially responsible entrepreneur. In 2001, together
                  with his partner Volodymyr Pepper, he founded Nova Post-
                  express delivery company which is now the fastest and the
                  biggest in Ukraine. In 2016, together with 18 Ukrainian
                  businessmen, Kondratuk founded and became president of the
                  Union of Ukrainian Entrepreneurs which now includes more than
                  800 members. He is still holding this position. Union's main
                  task is to create a favorable business environment in Ukraine
                  and to protect the interests of entrepreneurs.
                </div>
              </div>
            </div>
            <div className="people-slide">
              ...
              <div className="people-slide-about">
                ...
                <div className="people-slide-text">
                  ...
                  Volodymyr supports the principles of free economy and reducing
                  the role of the state in the economy of Ukraine.
                  Systematically supports the development of entrepreneurship in
                  Ukraine.
                </div>
              </div>
            </div>
